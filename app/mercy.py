...
SENTINEL_IMAGES = {
    r"C:\Users\Rohini Parthasarathy\Desktop\ai_resuce_platform\S3A_SL_2_LST__2023_S3A_ThermalPreview.jpg": {
    ...
    r"C:\Users\Rohini Parthasarathy\Desktop\ai_resuce_platform\Sentinel-1 SAR VV Image S1A_IW_GRDH_1SDV_202_S1A_SAR_VV.png": {
    ...
    r"C:\Users\Rohini Parthasarathy\Desktop\ai_resuce_platform\Sentinel-1 SAR VH Image S1A_IW_GRDH_1SDV_202_S1A_SAR_VH.png": {
...
def get_coordinates_from_address(address):
    try:
        geo = Nominatim(user_agent="helios-triage")
...
def classify_earthquake_zones(shake_json_path):
    try:
        ...
        geo = Nominatim(user_agent="helios-zone-locator")
        zone_data = []
...
def run_triage_dashboard():
    st.title("🚑 HELIOS Triage Dashboard")
...
def main():
    ...
    with tab2:
        st.title("🟥 HELIOS – Find Hospitals Nearby")
